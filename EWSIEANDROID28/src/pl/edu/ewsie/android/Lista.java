...
public class Lista extends Activity{
	...
	static final ViewBinder Poprawiacz = new ViewBinder() {
		...
		public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
			if(view.getId() == R.id.wtekst){
				CharSequence nowyTekst = cursor.getString(columnIndex);
				((TextView)view).setText(String.format("< %s >", nowyTekst));
				return true;
			}else if(view.getId() == R.id.wnumer){
